...
export function SignupForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(false)
    // In production, this would redirect after successful signup
  }
        ...
        <div className="space-y-3">
          ...
          >
            ...
            >
              ...
              <span className="text-xs text-muted-foreground text-center">Showcase & monetize</span>
            </Label>
            ...
            >
              ...
              <span className="font-medium text-foreground">Art Lover</span>
              <span className="text-xs text-muted-foreground text-center">Discover & support</span>
            </Label>
          </RadioGroup>
        </div>
